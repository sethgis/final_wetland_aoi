...
# RUN pip install geoserver-rest==0.1.0
# #RUN pip install pygdal==1.8.1.0
...
# # RUN pip install lxml pydantic Pygments pydantic-core shapely requests geopandas
# # RUN pip install pygdal=="`gdal-config --version`.*"
# # RUN pip install Wemast_wetland/wetland2/wet2/GDAL-3.2.3-cp37-cp37m-win_amd64.whl
...
# #RUN conda install geoserver_rest
# # RUN pip install geoserver_rest==0.1.0
...
# #/Users/sethnyawacha/Desktop/FAST_API/Wemast_wetland/Dockerfile
